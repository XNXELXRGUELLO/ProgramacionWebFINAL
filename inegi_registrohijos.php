...
<div class="barra">
  ...
  <body>
  <form action="inegi_procesar_registrohijos.php" enctype="multipart/form-data" method="POST" name="fotos-registro-frm">
<br>
<form action="/action_page.php">
  <label for="nombre">Nombre(s)</label>
  <input type="text" id="nombe" name="nombre" placeholder="Ingresa nombre(s)">
  <label for="apellidopa">Apellido paterno</label>
  <input type="text" id="apellidopa" name="apellidopa" placeholder="Ingresa apellido paterno">
  <label for="apellidopa">Apellido materno</label>
