...
<div class="barra">
  ...
  <body>
  <form action="inegi_procesar_registrofamilia.php" enctype="multipart/form-data" method="POST" name="fotos-registro-frm">
  <br>
  <form action="/action_page.php">
  <label for="domicilio">Domicilio</label>
  <input type="text" id="domicilio" name="domicilio" placeholder="Ingresa calle y numero de la vivienda">
